...
inline void ReTree::table_fill(vector<vector<int>>& table,vector<bool>& states,DFA_node* root)
{
    if(!root)   return;
...
inline void ReTree::re_match(const string& str)
{
    cout << endl;
